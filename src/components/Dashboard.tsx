          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <Progress 
                ...
                className="h-2" 
                indicatorClassName="bg-habit"
              />
              <Button 
                variant="outline" 
                className="w-full border-habit text-habit-dark hover:bg-habit/10"
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <Button 
                variant="outline" 
                className="w-full border-journal text-journal-dark hover:bg-journal/10"
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <Button 
                variant="outline" 
                className="w-full border-goal text-goal-dark hover:bg-goal/10"
                ...
                <ul className="space-y-2">
                  {habits.slice(0, 3).map(habit => (
                    <li key={habit.id} className="flex items-center">
                      ...
                      >
                        {habit.daysCompleted.includes(today) && (
                          <CheckCircle2 className="h-4 w-4 text-white animate-check-mark" />
                        )}
                      </div>
                      <div className="ml-3">
              ...
              {journalEntries.length > 0 ? (
                <ul className="space-y-2">
                  {journalEntries.slice(0, 2).map(entry => (
                    <li key={entry.id} className="p-2 rounded-md bg-muted/50">
